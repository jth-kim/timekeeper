...
client_time = df.groupby(['week', 'client_name'])['duration_seconds'].sum().reset_index()

# Pivot the dataframe for easier comparison
pivoted_df = client_time.pivot(index='week', columns='client_name', values='duration_seconds')
