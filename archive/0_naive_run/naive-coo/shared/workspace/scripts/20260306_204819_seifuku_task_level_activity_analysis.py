...
avg_session_durations = df.groupby('description')['duration_seconds'].mean().sort_values(ascending=False)

# Print the results in a sorted format, allowing for easy identification of tasks with the longest durations
